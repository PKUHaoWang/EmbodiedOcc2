...
eval_freq = 1
max_epochs = 20
load_from = None # path/to/monocheckpoint
...
confidence_refine_layer = dict(
    ...
    use_normal_constraint=use_normal_constraint,
    use_depth_guided_normal=use_depth_guided_normal,
    use_kappa_guidance=use_kappa_guidance,
    use_fusion_guidance=use_fusion_guidance,
